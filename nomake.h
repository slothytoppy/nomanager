...
unsigned int compile_file(char* compiler, char* flags[], char* file, char* destination, char* extension, ...){
...
if(flags==NULL){
					...
					unsigned int i=0;
					char** command=calloc(4+flagc, PATH_MAX);
					/*
					command[0]=compiler;
					command[1]="-o";
					...
					*/
					...
					printf("\n");
					LOG_INFO(NOM_DEBUG, "flagc:%d", 4+flagc);
